...
public class CampaniasC {
	...
	public List<HashMap<String, Object>> avanceEncuesta(CampaniaEO campania){
		...
		logger.debug("listadoInicial: {}",campania);
		listado = sqlSession.selectList("encuestas.admin.campania.avanceEncuesta", campania.getTablaContactos().toString());
		
		logger.debug("campania: {}",campania);
	...
	public List<HashMap<String, Object>> listadoVueltas(CampaniaEO campania){
		...
		params.put("tablaContactos", campania.getTablaContactos());
		params.put("idCampania", campania.getId());
		
		listado = sqlSession.selectList("encuestas.admin.campania.listadoVueltas", params);
	...
	public Integer conteoContactados(CampaniaEO campania){
		return sqlSession.selectOne("encuestas.admin.campania.conteoContactados", campania.getTablaContactos());
	}
