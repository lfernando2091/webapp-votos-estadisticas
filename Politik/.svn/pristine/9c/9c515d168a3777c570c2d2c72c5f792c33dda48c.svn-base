...
public class DependenciaEO extends JavaBeanT implements Serializable {
	...
	private NivelesDO nivelGeografico;
	private NivelesDependenciasDO nivelDependencia;
	...
	public NivelesDO getNivelGeografico() {
		return nivelGeografico;
	}


	public void setNivelGeografico(NivelesDO nivelGeografico) {
		this.nivelGeografico = nivelGeografico;
	}


	public NivelesDependenciasDO getNivelDependencia() {
		return nivelDependencia;
	}


	public void setNivelDependencia(NivelesDependenciasDO nivelDependencia) {
