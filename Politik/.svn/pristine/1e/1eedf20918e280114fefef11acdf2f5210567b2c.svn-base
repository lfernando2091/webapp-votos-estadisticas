...
public class VariablesC {
		...
		/*switch (importacion.getTipo()) {
			...
			case PARCIAL:*/
				if (importacion.getMapeoImportacion().getTablaSeleccionada().getParticionada()) {
					mapa.put("esquema",importacion.getMapeoImportacion().getTablaParticionSeleccionada().getEsquema().getNombre());
					mapa.put("nombreTabla", new String(importacion.getMapeoImportacion().getTablaSeleccionada().getTabla()+"_"+importacion.getMapeoImportacion().getTablaParticionSeleccionada().getParticion()));
				}
				else{
					mapa.put("esquema", importacion.getMapeoImportacion().getTablaSeleccionada().getEsquema().getNombre());
					mapa.put("nombreTabla",  importacion.getMapeoImportacion().getTablaSeleccionada().getTabla());
				}/*
			break;
		}*/
	...
	public void generarImportacionAsync(VariableEO variable){
		...
		Matcher m = p.matcher(variable.getCampo());
		if(m.matches()){
			mapa.put("campo", ("\""+variable.getCampo()+"\""));
		}
		else{
		...
		switch (variable.getNivelCalculo()) {
			case DFEDERAL:
				...
				break;
			case DLOCAL:
				variable.setDlocal(false);
				mapa.put("tabla", "dlocales");
				camposConsulta.put("id_entidad", variable.getImportacion().getCampoEntidad());
				camposConsulta.put("id_dlocal", variable.getImportacion().getCampoDLocal());
				break;
			case ENTIDAD:
				variable.setEntidad(false);
				mapa.put("tabla", "entidades");
				camposConsulta.put("id_entidad", variable.getImportacion().getCampoEntidad());
				break;
			case LOCALIDAD:
				variable.setLocalidad(false);
				mapa.put("tabla", "localidades");
				camposConsulta.put("id_entidad", variable.getImportacion().getCampoEntidad());
			...
			case MANZANA:
				...
				break;
			case MUNICIPIO:
				variable.setMunicipio(false);
				mapa.put("tabla", "municipios");
				camposConsulta.put("id_entidad", variable.getImportacion().getCampoEntidad());
				camposConsulta.put("id_municipio", variable.getImportacion().getCampoMunicipio());
				break;
			case SECCION:
				variable.setSeccion(false);
				mapa.put("tabla", "secciones");
				camposConsulta.put("id_entidad", variable.getImportacion().getCampoEntidad());
				camposConsulta.put("id_seccion", variable.getImportacion().getCampoSeccion());
				break;
...
//			mapa.put("valorDefault", variable.getValorDefault());
		...
		//Generar el Query para realizar el calculo
		log.setDescripcion("Actualización de Campo");
		sqlSession.insert("estadisticas.logs.insertar", log);
