...
public class EstructurasC {
	...
	public EstructuraEO obtenerPorId(Integer idEstructura){
		EstructuraEO estructura;
		
		estructura = sqlSession.selectOne("estructuras.estructuras.porId", idEstructura);
	...
	public NodoEO obtenerNodoPorId(Integer idNodo){
		NodoEO nodo;
		
		nodo = sqlSession.selectOne("estructuras.nodos.porId", idNodo);
