package com.saganet.politik.database.encuestas.edomex2017.entrevistaEntrevistador;
...
@Alias("Edomex2017EntrevistaEntrevistadorEO")
public class EntrevistaEO extends JavaBeanT implements Serializable {
	...
	public String toString() {
		return "EntrevistaEO [id=" + id + ", folio=" + folio + ", _1=" + _1 + ", _2=" + _2 + ", _3=" + _3 + ", _4=" + _4
				+ ", _5=" + _5 + ", _6=" + _6 + ", _7=" + _7 + ", _8=" + _8 + ", _9=" + _9 + ", _10=" + _10 + ", _11="
				+ _11 + ", nick=" + nick + ", fechaCaptura=" + fechaCaptura + ", fechaActualizacion="
				+ fechaActualizacion + ", resultado=" + resultado + "]";
	}
