...
public class CapturaC {
	...
	public String buscarId(RequestContext context, Integer id) {
		...
		entrevistado = sqlSession.selectOne("encuestas.sujetosSociales.entrevistado.buscarId", parametros);
	...
	public void guardar(RequestContext context) {
		...
		flowScope = (HashMap<String, Object>) context.getFlowScope().asMap();
	try{
		sqlSession.insert("encuestas.sujetosSociales.captura.insertar",flowScope);
		sqlSession.update("encuestas.sujetosSociales.captura.actualizarEstatus", flowScope);
	}catch(Exception e){
		logger.debug(" Error: {}",e.getCause());
	...
	public void actualizar(RequestContext context) {
		...
		HashMap<String, Object> flowScope;
		flowScope = (HashMap<String, Object>) context.getFlowScope().asMap();
		sqlSession.update("encuestas.sujetosSociales.captura.actualizarEncuesta", flowScope);
		sqlSession.update("encuestas.sujetosSociales.captura.actualizarEstatus", flowScope);
