...
import com.saganet.politik.database.encuestas.sujetosSociales.ResultadoEncuestaEO;

@Component("SujetosSocialesResultadoEncuestas")
public class ResultadoEncuestasC {
	...
	public Modelo<ResultadoEncuestaEO> modelo(NivelesReporteDO nivel, ProgramasEdoMexDO programa) {
		...
		if (nivel!=null) {
			switch (nivel) {
				case REGION:
					listado=sqlSession.selectList("encuestas.sujetosSociales.resultadoEncuestas.resultadoRegionPrograma",mapa);			
				break;
				case MUNICIPIO:
					listado=sqlSession.selectList("encuestas.sujetosSociales.resultadoEncuestas.resultadoMunicipioPrograma",mapa);
				break;
				case SECCION:
					listado=sqlSession.selectList("encuestas.sujetosSociales.resultadoEncuestas.resultadoSeccionPrograma",mapa);
				break;
			}
		}
	...
	public void generarMapa(RequestContext rc, NivelesReporteDO nivel, ProgramasEdoMexDO programa){
