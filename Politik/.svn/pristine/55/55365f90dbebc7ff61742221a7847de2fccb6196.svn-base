...
@Alias("FuerzaCiudadanaResultadoEncuestaEO")
public class ResultadoEncuestaEO extends JavaBeanT implements Serializable {
	...
	private ProgramaFuerzaCiudadanaDO programa;
	...
	public String getNumRegionF() {
		return String.format("%,d", numRegion);
	}
	...
	public ProgramaFuerzaCiudadanaDO getPrograma() {
		return programa;
	}
	public void setPrograma(ProgramaFuerzaCiudadanaDO programa) {
