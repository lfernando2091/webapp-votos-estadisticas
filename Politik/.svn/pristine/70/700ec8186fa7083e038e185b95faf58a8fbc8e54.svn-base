...
import com.saganet.politik.database.encuestas.hermanos.ResultadoEncuestaEO;

@Component("HermanosResultadoEncuestas")
public class ResultadoEncuestasC {
	...
	public Modelo<ResultadoEncuestaEO> modelo(NivelesReporteDO nivel) {
		...
		if (nivel!=null) {
			switch (nivel) {
				case REGION:
					listado=sqlSession.selectList("encuestas.hermanos.resultadoEncuestas.resultadoRegionPrograma",mapa);			
				break;
				case MUNICIPIO:
					listado=sqlSession.selectList("encuestas.hermanos.resultadoEncuestas.resultadoMunicipioPrograma",mapa);
				break;
				case SECCION:
					listado=sqlSession.selectList("encuestas.hermanos.resultadoEncuestas.resultadoSeccionPrograma",mapa);
				break;
			}
		}
