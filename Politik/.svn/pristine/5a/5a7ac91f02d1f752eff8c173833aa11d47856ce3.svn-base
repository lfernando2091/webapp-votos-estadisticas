	...
	public void generarMapa(RequestContext rc, NivelesReporteDO nivel, ProgramasEdoMexDO programa){
		...
		for(ResultadoEncuestaEO resultado : modelo.getListado()){
			...
			case MUNICIPIO:
				...
				dato.put("completadas", resultado.getTotal());
				dato.put("faltantes", resultado.getMeta() - resultado.getTotal());
		...
		case MUNICIPIO:
			...
			columnas.add(new Columna("Realizadas", "completadas", TiposColumnaDO.ENTERO));
