package com.saganet.politik.components.encuestas.sujetosSociales.respuestas;
...
@Component("SujetosSocialesEncuestasRespuestasC")
public class RespuestasC {
	...
	public HashMap<String, Object> modeloPregunta(HashMap<String, Object> fila, String pregunta, String programa) {
		...
		if (fila == null) {
			...
			try{
			listado = sqlSession.selectList("mencuestas.sujetosSociales.respuestas.otros.respuestas.listadoRegion", mapa);
			...
			try {
				listado = sqlSession.selectList("mencuestas.sujetosSociales.respuestas.otros.respuestas.listadoRegion",
						mapa);
