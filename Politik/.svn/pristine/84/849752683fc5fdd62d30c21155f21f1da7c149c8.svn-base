...
import com.saganet.politik.database.encuestas.edomex2017.ResultadoEncuestaCompletoEO;
import com.saganet.politik.database.encuestas.edomex2017.ResultadoEncuestaCompletoVerticalEO;

@Component("Edomex2017ResultadoEncuestasCompleto")
public class ResultadoEncuestasCompletoC {
	...
	public Modelo<ResultadoEncuestaCompletoEO> modelo(NivelesReporteDO nivel) {
		...
		if (nivel!=null) {
			switch (nivel) {
				case REGION:
					listado=sqlSession.selectList("encuestas.edomex2017.resultadoEncuestasCompletos.resultadoRegionPrograma",mapa);			
				break;
				case MUNICIPIO:
					listado=sqlSession.selectList("encuestas.edomex2017.resultadoEncuestasCompletos.resultadoMunicipioPrograma",mapa);
				break;
				case SECCION:
					listado=sqlSession.selectList("encuestas.edomex2017.resultadoEncuestasCompletos.resultadoSeccionPrograma",mapa);
				break;
			}
		}
