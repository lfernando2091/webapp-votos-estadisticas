...
public class ProgramasEjerciciosFuentesC {
	...
	public ProgramaEjercicioFuenteEO guardar(ProgramaEjercicioFuenteEO nuevo){
		...
		bitacoraC.insert(TiposAccionesDO.INSERTAR, "Programas", "Se agrego el tipo de inversión "+ nuevo.getTipoInversion() + " al programa "+ejercicio.getPrograma().getPrograma()+" del ejercicio " + ejercicio.getEjercicio(), nuevo.getNick());
	...
	public void eliminar(ProgramaEjercicioFuenteEO programaEjercicioFuenteEO){
		...
		bitacoraC.insert(TiposAccionesDO.ELIMINAR, "Programas", "Se eliminó el tipo de inversión "+ programaEjercicioFuenteEO.getTipoInversion() + " del programa " + ejercicio.getPrograma().getPrograma() + " en el ejercicio " + ejercicio.getEjercicio() , programaEjercicioFuenteEO.getNick());
	...
	public void actualizar(ProgramaEjercicioFuenteEO programaEjercicioFuenteEO){
		...
		bitacoraC.insert(TiposAccionesDO.ACTUALIZAR, "Programas", "Se actualizo el tipo de inversión "+ programaEjercicioFuenteEO.getTipoInversion() + " al programa "+ejercicio.getPrograma().getPrograma()+" del ejercicio " + ejercicio.getEjercicio(), getUsuario().getNick());
