...
import com.saganet.politik.database.encuestas.levantamientoRowan.ResultadoEncuestaCompletoEO;
import com.saganet.politik.database.encuestas.levantamientoRowan.ResultadoEncuestaCompletoVerticalEO;

@Component("LevantamientoRowanResultadoEncuestasCompleto")
public class ResultadoEncuestasCompletoC {
	...
	public Modelo<ResultadoEncuestaCompletoEO> modelo(NivelesReporteDO nivel) {
		...
		if (nivel!=null) {
			switch (nivel) {
				case REGION:
					listado=sqlSession.selectList("encuestas.levantamientoRowan.resultadoEncuestasCompletos.resultadoRegionPrograma",mapa);			
				break;
				case MUNICIPIO:
					listado=sqlSession.selectList("encuestas.levantamientoRowan.resultadoEncuestasCompletos.resultadoMunicipioPrograma",mapa);
				break;
				case SECCION:
					listado=sqlSession.selectList("encuestas.levantamientoRowan.resultadoEncuestasCompletos.resultadoSeccionPrograma",mapa);
				break;
			}
		}
