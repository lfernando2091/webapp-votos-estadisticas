...
public class ProgramasC {
	...
	public Modelo<ProgramaEO> modelo(ProgramaEO seleccionado){
		...
		if(!getUsuario().getDependencias().isEmpty()){
			...
			listado = sqlSession.selectList("catalogos.programas.listadoCompleto");
		}
	...
	public Modelo<ProgramaEO> modeloDual(){
		...
		listado = sqlSession.selectList("catalogos.programas.listado", params);
