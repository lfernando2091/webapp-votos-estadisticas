...
@Component("FuerzaCiudadanaResultadoEncuestas")
public class ResultadoEncuestasC {
	...
	public Modelo<ResultadoEncuestaEO> modelo(NivelesReporteDO nivel, List<ProgramaFuerzaCiudadanaDO> programas) {
		Modelo<ResultadoEncuestaEO> tabla;
		List<ResultadoEncuestaEO> listado=new ArrayList<>();
		HashMap<String, Object> mapa=new HashMap<>();
		mapa.put("programas", programas);
		...
		if (nivel!=null) {
			switch (nivel) {
				case REGION:
					listado=sqlSession.selectList("encuestas.fuerzaCiudadana.resultadoEncuestas.resultadoRegionPrograma",mapa);			
				break;
				case MUNICIPIO:
					listado=sqlSession.selectList("encuestas.fuerzaCiudadana.resultadoEncuestas.resultadoMunicipioPrograma",mapa);
				break;
				case SECCION:
					listado=sqlSession.selectList("encuestas.fuerzaCiudadana.resultadoEncuestas.resultadoSeccionPrograma",mapa);
				break;
			}
		}
	...
	public void generarMapa(RequestContext rc, NivelesReporteDO nivel, List<ProgramaFuerzaCiudadanaDO> programas){
