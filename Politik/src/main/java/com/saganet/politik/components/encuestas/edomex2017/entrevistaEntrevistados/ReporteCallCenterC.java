...
import com.saganet.politik.database.encuestas.edomex2017.entrevistaEntrevistados.ReporteCallCenterEO;
import com.saganet.politik.modelos.Modelo;

@Component("Edomex2017ReporteCallCenter2C")
public class ReporteCallCenterC {
	...
	public Modelo<ReporteCallCenterEO> modelo() {
		List<ReporteCallCenterEO> listado=sqlSession.selectList("encuestas.edomex2017.entrevistaEntrevistador.reporteCallCenter.listado2");
