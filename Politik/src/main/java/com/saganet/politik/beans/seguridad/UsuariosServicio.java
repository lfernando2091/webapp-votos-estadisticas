...
public class UsuariosServicio extends JdbcDaoImpl {
	...
	public void cargarPrograma2(UsuarioEO usuario) {	
		List<ProgramaFuerzaCiudadanaDO> programas=sqlSession.selectList("administracion.usuariosProgramas.usuarioPrograma2", usuario.getNick());
		usuario.setProgamas2(programas);
	}
