...
public class SeccionEO extends JavaBeanT implements Serializable {
	...
	public boolean contieneTerritorio(JavaBeanT territorio){
		return this.equals(territorio) || entidad.equals(territorio) || dFederal.equals(territorio) || dLocal.equals(territorio) || municipio.equals(territorio);
	}
